...
(facts
  ...
  "The most straightforward code is one where no issues raised ([e.{{ribol-normal-eq}}](#ribol-normal-eq))."
...
(facts
  ...
  [[:image {:src "img/escalate_norm.png" :height "300px" :title "Escalate :B, Choose :X Flow"}]]
    )
